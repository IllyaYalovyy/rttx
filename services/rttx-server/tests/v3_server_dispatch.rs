...
async fn v3_dispatch_create_and_list_workspaces() {
    ...
    let runtime_id =
        common::create_workspace(&mut client, "v3-test", rttx_proto::v3::WorkspacePolicy::Persistent)
            .await;
...
async fn v3_pane_output_seq_starts_at_zero_on_attach() {
    ...
    let runtime_id =
        common::create_workspace(&mut client, "seq-test", rttx_proto::v3::WorkspacePolicy::Persistent)
            .await;
