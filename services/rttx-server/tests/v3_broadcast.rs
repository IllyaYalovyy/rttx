...
use common::{attach_rw, create_pane, create_runtime, send_input, start_test_server, TestClient};
use rttx_proto::v3;
...
async fn pty_output_is_delivered_as_v3_output_delta() {
    ...
    let runtime_id = create_runtime(&mut client, "v3-broadcast", v3::RuntimePolicy::Persistent).await;
